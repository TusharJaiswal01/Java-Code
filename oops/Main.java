//note: java is platform independent language because of byte code jvm jav virtual machine help in this to become jre java runtime environment 
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.Map;
import javs.util.Map;
// cclass representing a product  and other testings are done and hte name is the dont 
class Product {
    private String id;
    private String name;
...
class Order {
    ...
    private int orderId;
    // this is private order id thsi is the test of the 
